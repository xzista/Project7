    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("phone", models.CharField(help_text="Введите номер телефона", max_length=35, verbose_name="Телефон")),
                (
                    "avatar",
                    models.ImageField(
                        blank=True, help_text="Загрузите свой аватар", null=True, upload_to="users/avatars/"
                    ),
                ),
